# Generated by Django 5.2.4 on 2025-08-27 06:59
            ...
            fields=[
                ...
                (
                    ...
                    models.PositiveIntegerField(
                        default=1, help_text="1=Tertinggi, semakin besar semakin rendah"
                    ),
                ),
                (
                    "warna_badge",
                    models.CharField(
                        default="#3B82F6",
                        help_text="Kode warna hex untuk badge",
                        max_length=7,
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="periode_kepengurusan",
                        to="organization.organization",
                    ),
                ),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "foto_profil",
                    models.ImageField(
                        blank=True, null=True, upload_to="organization/profiles/"
                    ),
                ),
                ...
                (
                    "bio",
                    models.TextField(blank=True, help_text="Biografi singkat anggota"),
                ),
                ...
                (
                    "prestasi",
                    models.TextField(
                        blank=True, help_text="Prestasi yang pernah diraih"
                    ),
                ),
                (
                    "is_featured",
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        to="organization.periodekepengurusan",
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "posisi_x",
                    models.IntegerField(
                        default=0, help_text="Posisi horizontal dalam bagan"
                    ),
                ),
                (
                    "posisi_y",
                    models.IntegerField(
                        default=0, help_text="Posisi vertikal dalam bagan"
                    ),
                ),
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        to="organization.anggotaorganisasi",
                    ),
                ),
                (
                    "organization",
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="organization.strukturorganisasi",
                    ),
                ),
                (
                    "periode",
