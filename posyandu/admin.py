...
class PosyanduLocationAdmin(admin.ModelAdmin):
    ...
    search_fields = ('name', 'address', 'coordinator__nama')
...
class HealthRecordAdmin(admin.ModelAdmin):
    ...
    search_fields = ('patient__nama', 'posyandu__name', 'diagnosis')
    readonly_fields = ('created_at', 'updated_at')
...
class ImmunizationAdmin(admin.ModelAdmin):
    ...
    search_fields = ('patient__nama', 'vaccine_name', 'posyandu__name')
    readonly_fields = ('created_at', 'updated_at')
    raw_id_fields = ('patient',)
...
class NutritionDataAdmin(admin.ModelAdmin):
    ...
    search_fields = ('patient__nama', 'posyandu__name')
    readonly_fields = ('created_at', 'updated_at')
    raw_id_fields = ('patient',)
